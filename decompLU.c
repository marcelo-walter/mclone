...
extern int PosicaoFinalVetorGeodesicPath;
extern VECTORGEODESICPATH *ArrayGeodesicPath;

/* 
 !! IMPORTANT !!
 Some of functions here exist too at matrix.c and rutil.c.
 I just leave here because I think that we will modify they in the
 future, and to simplify modification because are at the same context.
 */
