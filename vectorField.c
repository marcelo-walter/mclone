...
void MakeLUDecomposition3D(int Type)
{
	...
	if (Type)
	{
		...
		setMatrix(MatrixLUX, NumColunaLinha);
		setMatrix(MatrixLUY, NumColunaLinha);
		setMatrix(MatrixLUZ, NumColunaLinha);
	}
	else {
		//Using Geodesic Path Lenght
		setMatrixWithGeodesicPath(MatrixLUX, NumColunaLinha);
		setMatrixWithGeodesicPath(MatrixLUY, NumColunaLinha);
		setMatrixWithGeodesicPath(MatrixLUZ, NumColunaLinha);
	}
