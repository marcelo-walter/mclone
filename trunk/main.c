...
/* defined in readParFile.c */
void readParametersFile( const char *fileName );

/*defined in vectorfield.c*/
...
/* defined in interfacedistance.cpp using extern "C" to make the link (Vinicius 17/12/2004)*/
...
flag texturePresent = FALSE;

/* Added by Thompson at 09/12/2003 */
/* Flags if there is or not a vector file. */
